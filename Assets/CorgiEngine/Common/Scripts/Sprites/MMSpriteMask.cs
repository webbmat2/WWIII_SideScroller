...
namespace MoreMountains.CorgiEngine
{
	...
	public class MMSpriteMask : CorgiMonoBehaviour, MMEventListener<MMSpriteMaskEvent>
	{
		...
		protected virtual void SetupMaskSettingsAutomatically()
		{
			...
			{
				SpriteRenderer[] foundSpriteRenderers = FindObjectsByType<SpriteRenderer>(FindObjectsSortMode.None);
			...
			{
				TilemapRenderer[] foundTilemapRenderers = FindObjectsByType<TilemapRenderer>(FindObjectsSortMode.None);
			...
			{
				ParticleSystem[] foundParticleSystems = FindObjectsByType<ParticleSystem>(FindObjectsSortMode.None);
